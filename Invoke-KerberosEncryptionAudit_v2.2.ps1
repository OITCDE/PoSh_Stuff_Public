...
"@
        ...
        if (-not $modernEventsFound) {
            Write-Log "  No KB5073381 events found. Checking LEGACY Kerberos events..." -Level WARNING
            Write-Log "  (DC may need January 2026 updates - KB5073381)" -Level WARNING
...
<body>
    <div class="container">
        <div class="header">
            ...
            $(if ($usingModern) {
                '<div class="kb-badge">✅ KB5073381 Event IDs Active</div>'
            })
        </div>
...
@"
        <div class="legacy-warning">
            <strong>⚠️ LEGACY MODE ACTIVE - KB5073381 NOT DETECTED</strong><br><br>
            This Domain Controller has not received the <strong>January 2026 Windows updates (KB5073381)</strong> 
            that introduce enhanced RC4 tracking with Event IDs 201-209.<br><br>
            <strong>Action Required:</strong> Apply the latest Windows updates to enable:<br>
...
@"
        <div class="event-legend">
            <h3>📖 KB5073381 Event ID Reference - CVE-2026-20833</h3>
...
"@
        ...
        <div class="footer">
            ...
            <p>Microsoft KB5073381 Event IDs | CVE-2026-20833 Compliance</p>
            <p style="margin-top: 10px;">
                <a href="https://support.microsoft.com/topic/1ebcda33-720a-4da8-93c1-b0496e1910dc" target="_blank">📚 KB5073381 Documentation</a> | 
